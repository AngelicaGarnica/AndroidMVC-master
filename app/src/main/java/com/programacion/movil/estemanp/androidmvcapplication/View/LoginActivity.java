...
import com.programacion.movil.estemanp.androidmvcapplication.Controller.ControllerSingleton;
...
public class LoginActivity extends AppCompatActivity {
    ...
    ControllerSingleton appController;
    ...
    public void login(View view) {
        if(ControllerSingleton.get_instance().isValidUser(userName.getText().toString(),password.getText().toString())) {
